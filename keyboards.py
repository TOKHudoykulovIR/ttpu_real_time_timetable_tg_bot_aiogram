...
keyboard_2020 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text="ME1-2-20", callback_data="20:1.ME1-2-20"),
            InlineKeyboardButton(text="ME3-4-20", callback_data="20:1.ME3-4-20"),
        ],
        [
            InlineKeyboardButton(text="CIE1-2-20", callback_data="20:1CIE1-2-20"),
        ],
        [
            InlineKeyboardButton(text="IT1-20", callback_data="20:1IT1-20"),
            InlineKeyboardButton(text="IT2-20", callback_data="20:1IT2-20"),
            InlineKeyboardButton(text="IT3-20", callback_data="20:1IT3-20"),
            InlineKeyboardButton(text="IT4-20", callback_data="20:1IT4-20"),
        ],
        # [
...
keyboard_2019 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text="ME1-19", callback_data="19:2.ME1-19"),
            InlineKeyboardButton(text="ME2-19", callback_data="19:2.ME2-19"),
            InlineKeyboardButton(text="ME3-19", callback_data="19:2.ME3-19"),
            InlineKeyboardButton(text="ME4-19", callback_data="19:2.ME4-19"),
        ],
        [
        ...
        [
            InlineKeyboardButton(text="CIE-19", callback_data="19:2CIE1-19"),
            # InlineKeyboardButton(text="2CIE2-19", callback_data="19:2CIE2-19"),
        ],
        [
            InlineKeyboardButton(text="IT1-19", callback_data="19:2IT1-19"),
            InlineKeyboardButton(text="IT2-19", callback_data="19:2IT2-19"),
            InlineKeyboardButton(text="IT3-19", callback_data="19:2IT3-19"),
        ],
        [
            InlineKeyboardButton(text="IT4-19", callback_data="19:2IT4-19"),
            InlineKeyboardButton(text="IT5-19", callback_data="19:2IT5-19"),
            InlineKeyboardButton(text="IT6-19", callback_data="19:2IT6-19"),
        ],
        [
            InlineKeyboardButton(text='𝙱𝚊𝚌𝚔 ⬅️', callback_data='cancel')
        ]
